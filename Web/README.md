...
This repo includes a production-ready Docker setup and Unraid + Tailscale notes.
...
This project supports a Tailscale sidecar to keep the app private.
...
## Unraid + SWAG
See `DEPLOYMENT_UNRAID.md` for a full guide, including SWAG reverse-proxy
and multi-site setup.

## Security Notes
- Never commit `.env` or secrets.
- Use a long random `SESSION_SECRET`.
- Prefer HTTPS for OAuth flows.
